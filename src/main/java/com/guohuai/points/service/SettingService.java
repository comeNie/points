...
public class SettingService {
	 ...
	 * @param req
	 */
	public BaseResp savePoints(SettingForm req){
	 ...
	 * @param req
	 */
	public BaseResp updatePoints(SettingForm req){
	 ...
	 * @param req
	 */
	public BaseResp editPoints(SettingForm req){
	 ...
	 * @return
	 */
	public PageResp<PointSettingEntity> page(SettingForm req){
	 ...
	 * @return
	 */
	public Specification<PointSettingEntity> buildSpecification(final SettingForm req){
